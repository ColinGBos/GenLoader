...
public class WeightedBlockStateSerializer implements JsonSerializer<WeightedBlockState>
{
	GsonBuilder builder = new GsonBuilder();
	Gson gson = builder.create();

	@Override
	public JsonElement serialize(WeightedBlockState src, Type typeOfSrc, JsonSerializationContext context)
	{
